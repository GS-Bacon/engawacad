...
- t01_determinism: STEP 6 で実装後に解除
- t02_clean_history_extrude_tail_insert: STEP 6 で実装後に解除
- t03_strict_check_no_clean_regression: STEP 6 で実装後に解除
- t_269_boundary_self_dependency: STEP 6 で実装後に解除
- t_269_degen_clean_plane_ref_alive: STEP 6 で実装後に解除
- t_269_degen_plain_planeref_unaffected: STEP 6 で実装後に解除
- t_269_extrude_transitive_plane_ref_dead: STEP 6 で実装後に解除
- t_269_extrudecut_transitive_plane_ref_dead: STEP 6 で実装後に解除
- t_269_regression_266_full: STEP 6 で実装後に解除
- t_269_regression_267_full: STEP 6 で実装後に解除
