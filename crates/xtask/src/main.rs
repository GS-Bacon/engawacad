...
mod tests {
    ...
    static FEATURE_GOLDEN: &str = include_str!("../../../web/src/generated/Feature.ts");
    ...
    fn t02_feature_tagged_union() {
        ...
        assert!(
            actual.contains(r#""type": "sketch_mirror""#),
            "missing sketch_mirror tag"
        );
        assert!(
            actual.contains(r#""type": "sketch_pattern_linear""#),
            "missing sketch_pattern_linear tag"
        );
        assert!(
            actual.contains(r#""type": "sketch_pattern_circular""#),
            "missing sketch_pattern_circular tag"
        );
    }
