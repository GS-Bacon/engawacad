 ...
 */
export type Feature = { "type": "create_box", id: string, width: number, height: number, depth: number, suppressed?: boolean, } | { "type": "create_cylinder", id: string, radius: number, height: number, origin?: [number, number, number], suppressed?: boolean, } | { "type": "create_sphere", id: string, radius: number, center?: [number, number, number], suppressed?: boolean, } | { "type": "create_sketch", id: string, plane: SketchPlane, offset?: number, variables?: Array<Variable>, profile: Array<SketchSegment>, plane_ref?: PlaneRef | null, suppressed?: boolean, } | { "type": "extrude", id: string, sketch: string, depth: number, fuse_target?: string | null, suppressed?: boolean, } | { "type": "extrude_cut", id: string, sketch: string, depth: number, target: string, suppressed?: boolean, } | { "type": "cut", id: string, target: string, tool: string, suppressed?: boolean, } | { "type": "fuse", id: string, target: string, tool: string, suppressed?: boolean, } | { "type": "intersect", id: string, target: string, tool: string, suppressed?: boolean, };
"#;
