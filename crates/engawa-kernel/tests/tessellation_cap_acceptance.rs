...
fn shift_solid(solid: &mut engawa_kernel::brep::topology::Solid, dx: f64, dy: f64, dz: f64) {
...
fn build_intersect_cyl_sphere() -> engawa_kernel::brep::topology::Solid {
...
fn signed_volume(mesh: &engawa_kernel::tessellation::TriangleMesh) -> f64 {
    let mut vol = 0.0_f64;
...
fn assert_outward_normals(mesh: &engawa_kernel::tessellation::TriangleMesh, label: &str) {
...
fn t11_yaml_roundtrip_boolean_tessellation() {
    ...
    let restored: engawa_kernel::brep::topology::Solid =
